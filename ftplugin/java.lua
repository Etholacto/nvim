...
local sharePath = vim.fn.stdpath('data') .. 'mason/share'

-- Needed for debugging
local bundles = {
  vim.fn.glob(sharePath .. '/java-debug-adapter/com.microsoft.java.debug.plugin.jar'),
}

-- Needed for running/debugging unit tests
vim.list_extend(bundles,
  vim.split(vim.fn.glob(sharePath .. "/java-test/*.jar", 1), "\n"))
...
local config = {
  ...
  cmd = {
    ...
    '-Dlog.level=ALL',
    '-noverify',
    '-javaagent:' .. sharePath .. 'jdtls/lombok.jar',
    '-Xmx4g',
    ...
    '-jar', sharePath .. '/jdtls/plugins/org.eclipse.equinox.launcher.jar' ,
